...
let style_text =
  "border: 1px solid green; padding: 10px 20px; border-radius: 10px; font-size: 32px; width: 200px; height: auto; margin: 100px auto; text-align:center; background-color: teal; color: white";
